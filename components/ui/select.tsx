...
function SelectPositioner({
	...
	return (
		<BaseSelect.Positioner
			...
			// The positioner gets an inline transform (Floating UI), which creates a
			// stacking context. Without a z-index here the whole popup sits at
			// z-auto and renders *behind* a Dialog (z-50) when the select is inside
			// one. Lift it above the dialog.
